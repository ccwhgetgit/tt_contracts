...
contract("DAO", function (accounts) {
    ...
    it('Create Proposal', async() => { 
        ...
        let proposal1 = await daoInstance.createProposal("This is my proposal", {from:accounts[1]}); 
    ...
    it('Ensure Proposal Number is valid', async() => { 
        await truffleAssert.reverts(daoInstance.vote(10, true, {from:accounts[1]}) ,"Invalid proposal");        
    })
    ...
    it('Ensure Proposal reaches minimum Quorum', async() => { 
        ...
        await truffleAssert.reverts(daoInstance.endProposal(0, {from:accounts[0]}) ,"Quorum not reached");        
    ...
    it('Ensure Proposal can only closed by Owner', async() => { 
        await truffleAssert.reverts(daoInstance.endProposal(0, {from:accounts[1]}) ,"Not authorized");        
